...
Introduction
--------------
This project is a Verilog demo using the Basys 3, switches, LEDs, pushbuttons, and seven-segment display. When programmed onto the board, operands are taken from the switches and displayed on the LEDs. The pushbuttons select between subtraction, multiplication, division, and modulo operations and the result of the selected operation is displayed in hexadecimal on the seven segment. For photos of this demo in operation, check out it’s page on the Digilent Wiki.
